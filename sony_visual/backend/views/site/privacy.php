...
<div class="container" style="margin-bottom: 10%">
    ...
    operating system, unique device identifiers, IP address, mobile network information, or any other device-related
    information.
    <br><br>
        <strong>1.3 Usage Information:</strong><br> We do not collect any information on how you access or use the App, including the pages or
    features you visit, the time and date of your visits, or any other usage statistics.
    <br>
    <br>
    ...
    <br>
        ...
        <br>
        <strong>5.1</strong> The App may contain links to third-party websites, services, or advertisements that are not owned or controlled
    by us. We have no control over and assume no responsibility for the privacy practices of third-party sites or
    services. We encourage you to review the privacy policies of any third-party sites or services before providing any
    personal information.
    <br>
    <br>
    <strong>Children's Privacy:</strong><br>
        <strong>6.1</strong> The App is not intended for use by individuals under the age of 18. We do not knowingly collect personal
    information from children under 18.
    <br>
    <br>
        <strong>Changes to this Privacy Policy:</strong><br>
        <strong>7.1</strong> We reserve the right to update or modify this Privacy Policy at any time. Any changes or updates will be
    effective immediately upon posting the revised Privacy Policy on the App. Your continued use of the App after any
    changes or updates constitutes your acceptance of the revised Privacy Policy.
    <br>
    <br>
